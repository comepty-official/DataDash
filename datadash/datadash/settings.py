...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'storage.context_processors.storage_context',
            ],
        },
    },
]
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='DataDash <noreply@datadash.io>')

MAX_STORAGE_BYTES = config('MAX_STORAGE_BYTES', default=3221225472, cast=int)
